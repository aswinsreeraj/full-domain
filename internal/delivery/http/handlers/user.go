...
func SignupHandler(userService domain.UserService) gin.HandlerFunc {
...
func LoginHandler(userService domain.UserService) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func LogoutHandler(userService domain.UserService) gin.HandlerFunc {
	return func(c *gin.Context) {
		session := sessions.DefaultMany(c, "user_session")
		session.Clear()
		session.Save()
...
func UpdatePasswordHandler(userService domain.UserService) gin.HandlerFunc {
	return func(c *gin.Context) {
		session := sessions.DefaultMany(c, "user_session")
